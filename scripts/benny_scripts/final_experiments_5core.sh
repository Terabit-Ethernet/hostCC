...
# core experiments
sudo bash run-dctcp-tput-experiment.sh -E "cores-5" -M 4000 --num_servers 5 --num_clients 5 -c "4,8,12,16,20" --ring_buffer 256 --buf 1 --mlc_cores 'none' --bandwidth "100g" --server_intf ens2f1np1
sudo ethtool -G ens2f1np1 rx 2048
sudo bash run-dctcp-tput-experiment.sh -E "cores-6" -M 4000 --num_servers 6 --num_clients 6 -c "0,4,8,12,16,20" --ring_buffer 256 --buf 1 --mlc_cores 'none' --bandwidth "100g" --server_intf ens2f1np1
sudo ethtool -G ens2f1np1 rx 2048
sudo bash run-dctcp-tput-experiment.sh -E "cores-7" -M 4000 --num_servers 7 --num_clients 7 -c "0,4,8,12,16,20,24" --ring_buffer 256 --buf 1 --mlc_cores 'none' --bandwidth "100g" --server_intf ens2f1np1
sudo ethtool -G ens2f1np1 rx 2048
sudo bash run-dctcp-tput-experiment.sh -E "cores-8" -M 4000 --num_servers 8 --num_clients 8 -c "0,4,8,12,16,20,24,28" --ring_buffer 256 --buf 1 --mlc_cores 'none' --bandwidth "100g" --server_intf ens2f1np1
...
sudo bash run-dctcp-tput-experiment.sh -E "MTU1.5k" -M 1500 --num_servers 5 --num_clients 5 -c "4,8,12,16,20" --ring_buffer 256 --buf 1 --mlc_cores 'none' --bandwidth "100g" --server_intf ens2f1np1
...
sudo bash run-dctcp-tput-experiment.sh -E "flow10" -M 4000 --num_servers 10 --num_clients 10 -c "4,8,12,16,20" --ring_buffer 256 --buf 1 --mlc_cores 'none' --bandwidth "100g" --server_intf ens2f1np1
