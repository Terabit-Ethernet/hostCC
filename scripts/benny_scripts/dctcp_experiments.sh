...
sudo bash run-dctcp-tput-experiment.sh -E "tcp-buf1" -M 4000 --num_servers 4 --num_clients 4 -c "4,8,12,16" --ring_buffer 1024 --buf 1 --mlc_cores 'none' --bandwidth "100g" --server_intf ens2f1np1
